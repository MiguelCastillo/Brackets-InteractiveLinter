/**
* The content of this file is directly lifted from jshint
* with an adjustment to load underscore as well as making
* it requirejs/AMD friendly.  This has also been tweaked so
* that a map by description is available to more easilty
* figure out the code for older versions of jshint
*/
...
define(function(require, exports, module){
    ...
    exports.errors = {};
    exports.errorsByDescription = {};
    exports.warnings = {};
    exports.warningsByDescription = {};
    exports.info = {};
    exports.infoByDescription = {};

    _.each(errors, function (desc, code) {
        exports.errors[code] = { code: code, desc: desc };
        exports.errorsByDescription[desc] = { code: code, desc: desc };
    });

    _.each(warnings, function (desc, code) {
        exports.warnings[code] = { code: code, desc: desc };
        exports.warningsByDescription[desc] = { code: code, desc: desc };
    });

    _.each(info, function (desc, code) {
        exports.info[code] = { code: code, desc: desc };
        exports.infoByDescription[desc] = { code: code, desc: desc };
    });
